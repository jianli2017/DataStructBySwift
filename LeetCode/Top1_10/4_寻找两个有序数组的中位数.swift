...
class Solution_4_寻找两个有序数组的中位数 {
    func findMedianSortedArrays(_ nums1: [Int], _ nums2: [Int]) -> Double {
        let size1 = nums1.count
        let size2 = nums2.count
        if size1<=0 && size2<=0 {
            return 0
        }
        ...
        if total%2 == 1 { //奇数个
            ...
            let K1 = findKth(nums1, 0, nums2, 0, total/2)
            let K2 = findKth(nums1, 0, nums2, 0, total/2+1)
...
extension Solution_4_寻找两个有序数组的中位数 {
    static func test() {
        let instance = Solution_4_寻找两个有序数组的中位数()
        let result1 = instance.findMedianSortedArrays([1, 3], [2])
        print("测试示例1：\(result1)")
        
        let result2 = instance.findMedianSortedArrays([1, 2], [3,4])
        print("测试示例2：\(result2)")
        
        let result3 = instance.findMedianSortedArrays([6], [1,2,3,4,5])
        print("测试示例2：\(result3)")
    }
}
/*
