...
import Foundation
class LinkList<E : Equatable> :PrintLink, ListProtocal {
    ...
    static func test() {
        ...
        //测试删除
        //[7]_6   [6]_1   [1]_2   [2]_3   [3]_4   [4]_5   [5]_nil
        
        //[7]_6   [6]_1   [1]_2   [2]_3   [3]_4   [4]_nil
        if let remove = linkList.remove(index: 6) {
            print("删除元素 \(remove)")
        }
        linkList.printLink()
        
        //[6]_1   [1]_2   [2]_3   [3]_4   [4]_nil
        if let remove = linkList.remove(index: 0) {
            print("删除元素 \(remove)")
        }
        linkList.printLink()
        
        //[6]_1   [1]_3   [3]_4   [4]_nil
